...
create table tenant_server_connections(`id` BIGINT NOT NULL AUTO_INCREMENT,
    ...
    `pool_remove_abandoned` tinyint NULL DEFAULT '1',
    `pool_remove_abandoned_timeout` INT NULL DEFAULT '60',
    `pool_log_abandoned` tinyint NULL DEFAULT '1',
    `pool_abandon_when_percentage_full` INT NULL DEFAULT '50',
    `pool_test_on_borrow` tinyint NULL DEFAULT '1',
    `pool_max_active` INT NULL DEFAULT '40',
    `pool_min_idle` INT NULL DEFAULT '20',
    `pool_max_idle` INT NULL DEFAULT '10',
    `pool_suspect_timeout` INT NULL DEFAULT '60',
    `pool_time_between_eviction_runs_millis` INT NULL DEFAULT '34000',
    `pool_min_evictable_idle_time_millis` INT NULL DEFAULT '60000',
    `deadlock_max_retries` INT NULL DEFAULT '0',
